...
class TestFileVersion:
    ...
    def setUp(self):
        ...
        self.file_version = self.bucket.upload_bytes(b'nothing', 'test_file', cache_control='no-cache') #TODO fixture is created!
    ...
    def test_clone_file_version_and_download_version(self):
        ...
        initial_file_version = self.bucket.upload_bytes(
            ...
            file_infos={
                ...
                #TODO remove? 'b2-cache-control': 'unknown',
    ...
    def test_file_version_upload_headers(self):
        ...
        assert file_version._get_upload_headers() == """
            ...
            X-Bz-Info-b2-cache-control: no-cache
